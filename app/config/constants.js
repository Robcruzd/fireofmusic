...
export const TOP_ARTISTS = AUDIOSCROBBLER+'?method=geo.gettopartists&country=spain&api_key='+API_KEY+'&format=json'; 
export const TOP_TRACKS = AUDIOSCROBBLER+'?method=geo.gettoptracks&country=spain&api_key='+API_KEY+'&format=json'
...
export const IDTOKEN_FAILD = 'No ha sido posible recuperar su sesión';
